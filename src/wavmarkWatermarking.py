...
output_directory = Path("wavMark_watermarked_audios")
...
def watermark_bonafide_audio() -> None:
    for audio_file_bonafide in audiodir_bonafide.iterdir():
        ...
        watermarked_bonafide, _ = wavmark.encode_watermark(model, wav_bonafide, payload, show_progress=True)
...
def watermark_spoofed_audio() -> None:
    for audio_file_spoofed in audiodir_spoofed.iterdir():
        ...
        watermarked_spoofed, _ = wavmark.encode_watermark(model, wav_spoofed, payload, show_progress=True)
